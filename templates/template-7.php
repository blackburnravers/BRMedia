...
<style>
    ...
    .brmedia-waveform {
        width: 100%;
        height: <?php echo intval($settings['wave_height']); ?>px;
    }
    .brmedia-controls {
        position: absolute;
        bottom: 20px;
...
<div class="brmedia-fullwidth">
    ...
    <div class="brmedia-metadata">
        ...
        <?php endif; ?>
        <?php if ($audio_metadata['bitrate']): ?>
            <p><strong>Bitrate:</strong> <?php echo esc_html($audio_metadata['bitrate']); ?></p>
        <?php endif; ?>
        <?php if ($audio_metadata['sample_rate']): ?>
            <p><strong>Sample Rate:</strong> <?php echo esc_html($audio_metadata['sample_rate']); ?></p>
        <?php endif; ?>
        <?php if ($audio_metadata['error']): ?>
            <p><strong>Error:</strong> <?php echo esc_html($audio_metadata['error']); ?></p>
        <?php endif; ?>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (fullscreenBtn) {
        fullscreenBtn.addEventListener('click', function() {
            var elem = document.querySelector('.brmedia-fullwidth');
