...
<div class="brmedia-card">
    ...
    <div class="brmedia-content">
        <div class="brmedia-player">
            <button id="play-pause-btn" class="brmedia-play-pause" aria-label="Play/Pause"><i class="<?php echo esc_attr($settings['play_icon']); ?>"></i></button>
            <div id="waveform"></div>
            <audio id="audio" src="<?php echo esc_url($audio_url); ?>"></audio>
        </div>
        <div class="brmedia-controls">
            <?php if (in_array('volume', $selected_controls)): ?>
                <input type="range" id="volume-slider" min="0" max="1" step="0.01" value="<?php echo esc_attr($default_volume); ?>" aria-label="Volume">
            <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    wavesurfer.setVolume(<?php echo esc_attr($default_volume); ?>);
