...
class BRMedia_Import {
    private $services = [
        ...
        'reverbnation' => ['name' => 'ReverbNation', 'icon' => 'reverbnation.svg', 'color' => '#00A4A4'],
        'mixcloud' => ['name' => 'Mixcloud', 'icon' => 'mixcloud.svg', 'color' => '#1D2F5D'],
        'hearthis' => ['name' => 'HearThis.at', 'icon' => 'hearthis.png', 'color' => '#00C4B4'],
        'youtube-music' => ['name' => 'YouTube Music', 'icon' => 'youtube-music.svg', 'color' => '#FF0000'],
        'audius' => ['name' => 'Audius', 'icon' => 'audius.svg', 'color' => '#CC0FE0'],
        'drooble' => ['name' => 'Drooble', 'icon' => 'drooble.svg', 'color' => '#00AEEF'],
        'house-mixes' => ['name' => 'House-Mixes.com', 'icon' => 'house-mixes.png', 'color' => '#2E2E2E'],
    ];
