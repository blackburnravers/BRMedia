...
<div class="container-fluid mt-4">
    ...
    <form method="post" action="options.php">
        ...
        <!-- Moved Reset Button to be Next to Save Changes -->
        <div class="button-container">
            <?php submit_button('Save Changes', 'primary btn-lg', 'submit', false); ?>
            <button type="button" class="button button-secondary reset-template" 
        data-template="<?php echo esc_attr($selected_template); ?>" 
        data-template-name="<?php echo esc_attr($templates[$selected_template]); ?>">
    Reset Template
</button>
        </div>
    </form>
