...
function brmedia_register_template_settings() {
    ...
    foreach ($templates as $template_key => $template_name) {
        ...
        add_settings_field($template_key . '_icon_background_shape', 'Icon Background Shape', 'brmedia_select_callback', 'brmedia-template-settings-' . $template_key, 'brmedia_' . $template_key . '_general', ['template' => $template_key, 'field' => 'icon_background_shape', 'options' => ['none' => 'None', 'square' => 'Square', 'circle' => 'Circle', 'rounded' => 'Rounded']]);
        add_settings_field($template_key . '_icon_background_color', 'Icon Background Color', 'brmedia_color_picker_callback', 'brmedia-template-settings-' . $template_key, 'brmedia_' . $template_key . '_general', ['template' => $template_key, 'field' => 'icon_background_color']);
...
// Define default template options
function brmedia_get_default_template_options() {
    return [
        ...
        'enable_marquee' => 0,
        'marquee_speed' => 10,
        'marquee_behaviour' => 'scroll',
        'marquee_direction' => 'left',
        'marquee_loop' => -1,
        'enable_tracklist' => 0,
        'tracklist_background_color' => '#ffffff',
        'tracklist_text_color' => '#000000',
        'tracklist_time_text_color' => '#000000',
        'tracklist_box_size' => 300,
        'enable_cover_image' => 0,
        'cover_image_size' => 200,
        'show_artist' => 0,
        'show_bpm' => 0,
        'show_key' => 0,
        'show_duration' => 0,
        ...
        'unmute_icon' => 'fas fa-volume-up',
        'speed_icon' => 'fas fa-tachometer-alt',
        'rewind_icon' => 'fas fa-backward',
        'fast_forward_icon' => 'fas fa-forward',
        'repeat_icon' => 'fas fa-redo',
        'skip_forward_icon' => 'fas fa-step-forward',
        'skip_backward_icon' => 'fas fa-step-backward',
        'share_icon' => 'fas fa-share',
        'fullscreen_icon' => 'fas fa-expand',
        'cast_icon' => 'fas fa-cast',
        'shuffle_icon' => 'fas fa-random',
        'tracklist_icon' => 'fas fa-list',
    ];
}
...
function brmedia_sanitize_template_settings($input) {
    if (isset($_POST['reset'])) {
        return brmedia_get_default_template_options();
    }
    $sanitized_input = [];
    // General Settings
    ...
    $sanitized_input['icon_background_shape'] = in_array($input['icon_background_shape'] ?? 'none', ['none', 'square', 'circle', 'rounded']) ? $input['icon_background_shape'] : 'none';
    $sanitized_input['icon_background_color'] = sanitize_hex_color($input['icon_background_color'] ?? '#ffffff');
    ...
    $sanitized_input['tracklist_box_size'] = intval($input['tracklist_box_size'] ?? 300);
