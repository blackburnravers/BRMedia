...
<div class="container-fluid mt-4">
    ...
    <div class="row">
        ...
        <?php if (!empty($settings['enable_video'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_podcast'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_radio'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_gaming'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_chat'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_downloads'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
        ...
        <?php endif; ?>
        <?php if (!empty($settings['enable_footbar'])): ?>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
