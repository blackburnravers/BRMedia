...
/**
 * BRMedia General & Advanced Settings Page
 */
function brmedia_general_settings_page() {
    ?>
    <div class="wrap brmedia-admin-container">
        <h1>General & Advanced Settings</h1>
        <form method="post" action="options.php">
            <?php
            settings_fields('brmedia_general_settings_group');
            do_settings_sections('brmedia_general_settings');
            submit_button();
            ?>
        </form>
    </div>
...
function brmedia_register_general_settings() {
    register_setting('brmedia_general_settings_group', 'brmedia_general_settings');
    ...
    add_settings_field(
        ...
        'brmedia_general_section',
        [
            'option_name' => 'brmedia_general_settings',
...
add_action('admin_init', 'brmedia_register_general_settings');
